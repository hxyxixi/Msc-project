...
def get_common_args():
    ...
    parser.add_argument('--map', type=str, default='mapf0', help='the map of the game')
    ...
    parser.add_argument('--alg', type=str, default='reinforce', help='the algorithm to train the agent')#change algorithm
    ...
    parser.add_argument('--load_model', type=bool, default=True, help='whether to load the pretrained model')#Train:F or Test:T
    parser.add_argument('--learn', type=bool, default=False, help='whether to train the model')#Train:T or Test:F
